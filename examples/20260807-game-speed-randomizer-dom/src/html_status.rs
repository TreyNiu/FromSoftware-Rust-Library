...
const DATA_BLOCK_START: &str =
    r#"<script id="game-speed-randomizer-data" type="application/json">"#;
...
<title>Game Speed Randomizer</title>
<style>
...
<script id="game-speed-randomizer-data" type="application/json">
{"enabled":false,"speedEnabled":false,"multiplier":1.0,"countdown":"--:--"}
</script>
<script>
(() => {
 const data = JSON.parse(document.getElementById("game-speed-randomizer-data").textContent);
