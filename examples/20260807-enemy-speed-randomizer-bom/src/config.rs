...
const HTML_FILE_NAME: &str = "enemy_speed_randomizer_bom.html";
...
mod tests {
    ...
    #[test]
    fn generated_config_contains_only_enemy_speed_settings() {
    ...
    fn paths_use_dll_directory() {
        ...
        assert_eq!(
            paths.html_path,
            PathBuf::from(r"D:\Games\EldenRing\mods\enemy_speed_randomizer_bom.html")
        );
    }
}
